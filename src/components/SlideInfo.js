...
import { db } from '../firebaseConfig';
 ...
 const SlideInfo = () => {
  ...
  return (
    <section className='slide2 flex-col-row padding-slide'>
      <div id="contacts" className='slide2_section info-container'>
        <div className="width-100 popup-anim">
          <h2 className="subheading font-fancy">Contacts</h2>
        ...
        <div className="inline width-100 font-regular pointer margin-btm-mid  opacity-anim">
            ...
            <button className="email font-regular" onClick={() => window.location = 'mailto:yourmail@domain.com'}>bmoreproteinpub@gmail.com</button>
        </div>
      </div>
          
      <div id='location' className="find-us-section slide2_section ">
        <div className="width-100 popup-anim">
      ...
      <div id="hours" className="opening-hours popup-anim schedule font-regular" >
        ...
        hoursData.map((item, index) => (
          ...
          " key={index}>
            <div className='beige-light'>{item.day}</div> 
            <div className='flex-col-left'>
              {
              item.hours.map((hour, hourIndex) => ( <div key={hourIndex} className="time">{hour}</div> ))
              }
            </div>
          </div>
        ))
