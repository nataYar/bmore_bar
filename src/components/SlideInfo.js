 ...
 const SlideInfo = () => {
  return (
    <section className='slide2 flex-col-row' id='location'>
                <div className='slide2_section info-container opacity-anim'>
                  ...
                  <a className="margin-btm-mid flex-row" href="https://www.instagram.com/bmoreproteinpub" target="_blank" rel="noreferrer" >
                    <div className='sm-icon insta'></div>
                    <div className="font-regular">@bmoreproteinpub</div>
                  </a>
                  <a  className="margin-btm-mid flex-row" href="https://www.yelp.com/biz/bmore-protein-pub-long-beach" target="_blank" rel="noreferrer">
                  ...
                  <a className="margin-btm-mid flex-row" href="https://www.facebook.com/bmoreproteinpub/" target="_blank" rel="noreferrer">
                    <div className='sm-icon yelp' >
